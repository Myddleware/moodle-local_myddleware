...
Need more functionalities ? Please [Contact us](http://www.myddleware.com/contact-us){:target="_blank"}

Please, install first the [Myddleware Moodle plugin](https://moodle.org/plugins/local_myddleware){:target="_blank"}

Generate your token by following this tutorial : [here](https://docs.moodle.org/400/en/Using_web_services){:target="_blank"}

You can use this system role and assigned it to the user linked to your token. Click on this link to download it, then unzip it before importing it in Moodle : ![here](http://community.myddleware.com/wp-content/uploads/2016/11/myddleware_moodle_role_1.3-1.zip)
...
> Make sure you have installed the Myddleware Moodle plugin if you don’t find these functions in the list. [here](https://moodle.org/plugins/local_myddleware){:target="_blank"}
...
Find us here : [Myddleware](http://www.myddleware.com){:target="_blank"}
